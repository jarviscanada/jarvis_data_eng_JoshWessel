...
public class MarketDataDaoIntTest {
  ...
  private final Logger logger = LoggerFactory.getLogger(MarketDataDaoIntTest.class);
  ...
  public void init() {
    ...
    dao = new MarketDataDao(marketDataConfig);
  }

  @Test
  public void findIndexQuotesByTickers() throws IOException {
    // Happy Path
