...
public class TraderAccountController {
  ...
  public void createTrader(@PathVariable String firstname,
  ...
  @ApiOperation(value = "Create a trader and an account with DTO", notes = "TraderId and AccountId are auto generated by the database, and they should be identical")
  @ResponseStatus(HttpStatus.CREATED)
  @ResponseBody
  ...
  @ApiOperation(value = "Delete a trader",
    notes = "Delete a trader if its account amount is 0 and there are no open positions." +
